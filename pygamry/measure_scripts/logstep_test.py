...
chrono.configure_logstep_signal(
    s_init, s_half_step, t_init, t_long, t_sample, num_scales
)
...
chrono.run(pstat, result_file=result_file, kst_file=kst_file, decimate=decimate)
print("CHRONO done\n")
