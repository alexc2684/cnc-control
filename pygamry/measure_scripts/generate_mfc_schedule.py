...
parser = argparse.ArgumentParser(
    description="Generate flow schedule for individual MFCs"
)
...
mfc_schedule, _ = generate_mfc_schedule(
    channel_config_file, channel_schedule_file, None, schedule_path
)
